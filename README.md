This file takes a simple list of URLs (usually exported with MarcEdit) from the OECD files and checks their website for the precence of an access phrase.
